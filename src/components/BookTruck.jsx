...
import TataLpt from "../images/truck-big/lpt.jpg";
...
function BookTruck() {
  ...
  const [truckImg, setTruckImg] = useState("");
            ...
            <div className="book-content__box">
              ...
              <form className="box-form">
                <div className="box-form__car-type">
                  <label>
                    <i className="fa-solid fa-car"></i> &nbsp; Select Your Truck
                    Type <b>*</b>
                  </label>
                  <select value={truckType} onChange={handleCar}>
                    ...
                    <option value="Ashok Leyland AVTR 1920-4x2 Haulage">Ashok Leyland AVTR 1920-4x2 Haulage</option>
                ...
                <div className="box-form__car-type">
                  ...
                  <select value={pickUp} onChange={handlePick}>
                    ...
                    <option>Nagerkovil</option>
                    <option>kanyakumai</option>
                  </select>
                </div>
